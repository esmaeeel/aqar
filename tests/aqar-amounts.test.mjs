...
test("لا يعامل سعر المتر في رأس 6828963 كسعر إجمالي", () => {
  const html = `<h1>ورشة للبيع في مدينة الرياض</h1><div>25,000 ﷼ سعر للمتر</div><div>استكشف خيارات التمويل</div><p>المساحة 1,265.8 م²</p><h3>تفاصيل الإعلان</h3><div>رقم الإعلان 6828963</div>`;
  const listing = parseListing(html, "https://sa.aqar.fm/ورش-للبيع/الرياض/ورشة-6828963", "ورشة");
  assert.equal(listing.price, null);
  assert.equal(listing.sqmPrice, 25_000);
});
