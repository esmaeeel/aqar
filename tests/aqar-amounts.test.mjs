...
test("لا يعامل سعر المتر في رأس 6828963 كسعر إجمالي", () => {
  const html = `<h1>ورشة للبيع في مدينة الرياض</h1><div>2,500 ﷼ للمتر</div><div>استكشف خيارات التمويل</div><p>المساحة 840 م²</p><h3>تفاصيل الإعلان</h3><div>رقم الإعلان 6828963</div>`;
